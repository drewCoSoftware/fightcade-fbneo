...
void CGamepadMappingsFile::GetGamepadMapping(GUID& productGuid, CGamepadButtonMapping& mapping)
{
	...
	if (IsEqualGUID(productGuid, LOGITECH_510)) {
		...
		mapping.Entries[12] = { GPINPUT_BACK, ITYPE_BUTTON, 0x08 };
		mapping.Entries[13] = { GPINPUT_START, ITYPE_BUTTON, 0x09 };

		mapping.Entries[14] = { GPINPUT_X, ITYPE_BUTTON, 0x00 };
		mapping.Entries[15] = { GPINPUT_Y, ITYPE_BUTTON, 0x03 };
		mapping.Entries[16] = { GPINPUT_A, ITYPE_BUTTON, 0x01 };
		mapping.Entries[17] = { GPINPUT_B, ITYPE_BUTTON, 0x02 };

		
		mapping.Entries[18] = { GPINPUT_LEFT_BUMPER, ITYPE_BUTTON, 0x04 };
		mapping.Entries[19] = { GPINPUT_LEFT_TRIGGER, ITYPE_BUTTON, 0x06 };

		mapping.Entries[20] = { GPINPUT_RIGHT_BUMPER, ITYPE_BUTTON, 0x05 };
		mapping.Entries[21] = { GPINPUT_RIGHT_TRIGGER, ITYPE_BUTTON, 0x07 };
...
void CGamepadMappingsFile::GetDefault(CGamepadButtonMapping& mapping) {
	...
	// ?? Maybe......
	mapping.Entries[18] = { GPINPUT_LEFT_BUMPER, ITYPE_BUTTON, 0x04 };
	mapping.Entries[19] = { GPINPUT_LEFT_TRIGGER, ITYPE_TRIGGER, 0x05 };

	mapping.Entries[20] = { GPINPUT_RIGHT_BUMPER, ITYPE_BUTTON, 0x05 };
	mapping.Entries[21] = { GPINPUT_RIGHT_TRIGGER, ITYPE_TRIGGER, 0x04 };
